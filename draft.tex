...
%&=& \mathbb{E}_{\Lambda(\boldsymbol{x})}\bigg[\sum_{i=1}^{n}{r_{i}^{2}(\boldsymbol{x_{i}})\lambda_{i}^{2}(\boldsymbol{x_{i}})T^{2}}\bigg] + \sum_{i=1}^{n}{r_{i}^{2}(\boldsymbol{x_{i}})\mu_{i}(\boldsymbol{x_{i}})T} - \bigg[T\sum_{i=1}^{n}{r_{i}(\boldsymbol{x_i})\mu_{i}(\boldsymbol{x_i})}\bigg]^{2} \nonumber\\
