...
%\begin{eqnarray}
% \mathbb{E}_{\Lambda(\boldsymbol{x})} \mathbb{E}_{S}\bigg[D(\boldsymbol{x})\bigg]= \mathbb{E}_{\Lambda(\boldsymbol{x})} \mathbb{E}_{S}\bigg[ \bigg]
...
%% &&\bigg[\sum_{i=1}^{n}{s_{i}r_{i}(\boldsymbol{x_{i}})}\bigg]\prod_{i=1}^{n}{f_{\Lambda_{i}(\boldsymbol{x_{i}})}(\lambda_{i})d\lambda_{1}\dots d\lambda_{n}} \nonumber
%\end{eqnarray}
...
%&=& \sum_{s_{1}=1}^{\infty}{\frac{e^{-\Lambda_{1}(\boldsymbol{x_{1}})T}(\Lambda_{1}(\boldsymbol{x_{1}})T)^{s_{1}}}{s_{1}!}}\dots\sum_{s_{n}=1}^{\infty}{\frac{e^{-\Lambda_{n}(\boldsymbol{x_{n}})T}(\Lambda_{n}(\boldsymbol{x_{n}})T)^{s_{n}}}{s_{n}!}}\bigg[\sum_{i=1}^{n}s_{i}r_{i}(\boldsymbol{x_i})-D_{0}\bigg]^{+}c_{p} \nonumber
\end{eqnarray}
...
%$(n_{5},\sigma_{0.2},D_{01})$ &\{3.6787, 3.6550, 0.0237, 0.64\%\}&(3.6619, 3.6955)& (0.96\%, 1.60\%) \\
%$(n_{5},\sigma_{0.2},D_{02})$ &\{2.6477, 2.6530, 0.0053, 0.20\%\}&(2.6314, 2.6640)& (1.36\%, 2.07\%) \\
%$(n_{5},\sigma_{0.2},D_{03})$ &\{1.8389, 1.8858, 0.0469, 2.55\%\}&(1.8242, 1.8536)& (2.34\%, 3.74\%) \\
%$(n_{5},\sigma_{0.2},D_{04})$ &\{1.2513, 1.3145, 0.0632, 5.05\%\}&(1.2417, 1.2609)& (4.38\%, 5.95\%) \\
%$(n_{5},\sigma_{0.2},D_{05})$ &\{0.8208, 0.9000, 0.0792, 9.65\%\}&(0.8133, 0.8282)& (8.77\%, 10.75\%) \\
%$(n_{5},\sigma_{0.4},D_{01})$ &\{4.0780, 4.0356, 0.0424, 1.04\%\}&(4.0595, 4.0964)& (1.08\%, 1.77\%) \\
%$(n_{5},\sigma_{0.4},D_{02})$ &\{3.0202, 3.0342, 0.0140, 0.46\%\}&(3.0023, 3.0381)& (1.24\%, 2.04\%) \\
%$(n_{5},\sigma_{0.4},D_{03})$ &\{2.1990, 2.2458, 0.0468, 2.13\%\}&(2.1833, 2.2148)& (2.01\%, 3.22\%) \\
%$(n_{5},\sigma_{0.4},D_{04})$ &\{1.5783, 1.6382, 0.0599, 3.80\%\}&(1.5674, 1.5892)& (3.24\%, 4.62\%) \\
%$(n_{5},\sigma_{0.4},D_{05})$ &\{1.0964, 1.1791, 0.0827, 7.54\%\}&(1.0873, 1.1056)& (6.74\%, 8.52\%) \\
%$(n_{5},\sigma_{0.6},D_{01})$ &\{4.5712, 4.5010, 0.0702, 1.54\%\}&(4.5490, 4.5934)& (1.47\%, 2.21\%) \\
%$(n_{5},\sigma_{0.6},D_{02})$ &\{3.5254, 3.5033, 0.0221, 0.63\%\}&(3.5037, 3.5471)& (1.37\%, 2.13\%) \\
%$(n_{5},\sigma_{0.6},D_{03})$ &\{2.6601, 2.6963, 0.0362, 1.36\%\}&(2.6443, 2.6759)& (1.68\%, 2.49\%)\\
%$(n_{5},\sigma_{0.6},D_{04})$ &\{1.9770, 2.0538, 0.0388, 7.68\%\}&(1.9657, 1.9882)& (3.36\%, 4.52\%)\\
%$(n_{5},\sigma_{0.6},D_{05})$ &\{1.4506, 1.5496, 0.0990, 6.82\%\}&(1.4405, 1.4606)& (6.15\%, 7.63\%)\\
%$(n_{50},\sigma_{0.2},D_{01})$ &\{16.2478, 14.8786, 1.3692, 8.43\%\}&(16.1817, 16.3140)& (8.04\%, 8.78\%)\\
%$(n_{50},\sigma_{0.2},D_{02})$ &\{4.0826, 4.2366, 0.154, 3.77\%\}&(4.0511, 4.1140)& (3.36\%, 4.77\%)\\
%$(n_{50},\sigma_{0.2},D_{03})$ &\{0.6117, 0.8190, 0.2073, 33.89\%\}&(0.6002, 0.6233)& (31.89\%, 37.06\%)\\
%$(n_{50},\sigma_{0.2},D_{04})$ &\{0.0279, 0.1086, 0.0807, 289.25\%\}&(0.0256, 0.0302)& (286.89\%, 364.79\%)\\
%$(n_{50},\sigma_{0.2},D_{05})$ &\{0.0026, 0.0101, 0.0075, 288.46\%\}&(0.0020, 0.0302)& (286.89\%, 364.79\%)\\ 